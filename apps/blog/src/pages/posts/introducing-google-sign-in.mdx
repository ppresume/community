...
![Google Sign In](/static/images/introducing-google-sign-in/google-sign-in-logto.png)
![Google Sign In OAuth Consent](/static/images/introducing-google-sign-in/google-sign-in-oauth-consent.png)
...
![Google Sign In Account Linking](/static/images/introducing-google-sign-in/google-sign-in-account-linking.png)
...
![Logto Google Connector Item](/static/images/introducing-google-sign-in/logto-google-connector-item.png)
![Logto Google Connector Detail](/static/images/introducing-google-sign-in/logto-google-connector-detail.png)
...
![Logto Social Connectors List](/static/images/introducing-google-sign-in/logto-social-connectors-list.png)
