...
date: 2023-10-31
description: >
  A LaTeX-based resume builder that creates beautifully typeset resumes in
  minutes.
...
Welcome to [PPResume](https://ppresume.com), a LaTeX-based resume builder that
...
satisfied with the high-quality, beautifully typeset resumes.

To my surprise, some of them still come back to me after several years and ask
me to help them update their resumes again when they are looking for a new job.
...
offer people high-quality, beautifully typeset resumes, there could be a market
for it.
...
people create beautifully typeset resumes in minutes.
...
am not saying that you can not create beautifully typeset resume PDFs with
...
beautifully typeset PDFs. It is widely used in academia and research, especially
...
second was created with [PPResume](https://ppresume.com/), which uses LaTeX
instead. Feel the difference yourself and see which version is more balanced,
elegant and beautiful in terms of typesetting.

![example Resume by RXResume](/static/images/introducing-ppresume/andy-dufresne-rxresume-example.svg)

![example Resume by PPResume](/static/images/introducing-ppresume/andy-dufresne-ppresume-example.svg)

If you have a keen eye and prefer beautifully typeset resumes with extremely
...
opportunity. A carefully crafted, beautifully typeset resume can help you stand
...
![PPResume POC](/static/images/introducing-ppresume/ppresume-poc.png)
...
![PPResume Launch](/static/images/introducing-ppresume/ppresume-launch.png)
...
![Real-Time Input Validation](/static/images/introducing-ppresume/real-time-input-validation.gif)
...
![Rich Set of Input Controls](/static/images/introducing-ppresume/rich-set-of-input-controls.gif)
...
![Structural Editing](/static/images/introducing-ppresume/structural-editing.gif)
...
![Customizable Layout](/static/images/introducing-ppresume/customizable-layout.gif)
