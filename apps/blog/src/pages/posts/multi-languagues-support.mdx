...
![English Resume](/static/images/multi-languages-support/andy-dufresne-en-0.png)

- Simplified Chinse resume:

![Simplified Chinse Resume](/static/images/multi-languages-support/zhang-xiaomeng-zh-cn-0.png)

- Traditional Chinese HK resume:

![Traditional Chinse HK Resume](/static/images/multi-languages-support/zhang-xiaomeng-zh-hk-0.png)

- Traditional Chinese TW resume:

![Traditional Chinse TW Resume](/static/images/multi-languages-support/zhang-xiaomeng-zh-tw-0.png)
...
2. [number](https://www.lifewire.com/how-to-typeset-numbers-1077695) in English
...
- [Internationalization](https://phrase.com/blog/posts/internationalization-vs-localization/#what-is-internationalization-i18n),
  ...
  mutli languages and dynamically switching the langauge according to the user's
  choice
...
CVs in addition to the pure i18n translation.
...
in zh-TW, it is "軟體". There are about tens of words in English that are
...
zh-HK and zh-TW, because some countries have different names in zh-HK and zh-TW.
...
countries. PPResumes takes care of all countries that has different translations
in zh-HK and zh-TW.
...
Don't worry, PPResumes has already handled this for you.
...
With PPResumes's [TagsInput](https://mantine.dev/core/tags-input/) component for
